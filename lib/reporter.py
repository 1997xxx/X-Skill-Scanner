...
body{font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif;margin:0;padding:20px;background:#f0f2f5;color:#333;line-height:1.6}
.ctn{max-width:960px;margin:0 auto;background:#fff;padding:32px;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,.08)}
...
.src-hdr td{background:#e9ecef!important;font-weight:700;font-size:12px;color:#495057;text-transform:uppercase;letter-spacing:.5px;padding:6px 10px;border-bottom:2px solid #dee2e6}
...
.nav-btn{width:44px;height:44px;border-radius:50%;border:none;background:#007bff;color:#fff;font-size:20px;cursor:pointer;box-shadow:0 2px 8px rgba(0,0,0,.2);display:flex;align-items:center;justify-content:center;text-decoration:none;transition:background .2s,transform .15s}
.nav-btn:hover{background:#0056b3;transform:scale(1.1)}
th{background:#f8f9fa;font-weight:600;padding:8px 10px;text-align:left;border-bottom:2px solid #dee2e6;white-space:normal;line-height:1.4}
td{padding:8px 10px;border-bottom:1px solid #eee;vertical-align:top;overflow-wrap:break-word;word-break:break-word;max-width:0}
.cs{width:75px;white-space:nowrap}.ci{min-width:0}.cl{width:160px;overflow:hidden}.cr{width:120px;overflow:hidden}
.cr code,.cl code{font-size:12px;word-break:break-all;overflow-wrap:break-word;max-width:100%;display:inline-block}
.cr small,.cl small{font-size:11px;display:block;margin-top:2px}
.sc{color:#dc3545;font-weight:700}.sh{color:#fd7e14;font-weight:700}
.sm{color:#e6a800;font-weight:600}.slo{color:#28a745}
.mbadge{display:inline-block;background:#6c757d;color:#fff;font-size:11px;padding:2px 6px;border-radius:10px;margin-left:6px;vertical-align:middle}
.cb{background:#1e1e1e;color:#d4d4d4;padding:10px 14px;border-radius:6px;margin:8px 0;overflow-x:auto;font-family:"SF Mono","Fira Code",monospace;font-size:13px;line-height:1.5;white-space:pre-wrap;word-break:break-all;max-height:180px;max-width:100%}
...
.sumbox{font-size:14px}.sumrow{display:flex;justify-content:space-between;padding:4px 0;gap:16px}.sumlbl{font-weight:600;white-space:nowrap;flex-shrink:0}
@media(max-width:768px){.ctn{padding:16px}table{font-size:12px}th,td{padding:8px 6px}.cl{display:none}.sts{grid-template-columns:repeat(2,1fr)}}"""
